var exec, fs, logger, path, register, retrieveRegistry, rimraf, windowsDrive, wrench, _cleanup, _cloneGitHub, _isGitHub, _isSystemPath, _moveDirectoryContents, _newSkeleton;
...
register = function(program) {
  var _this = this;
  return program.command('skel:new <skeletonName> [directory]').description("Create a Mimosa project using a skeleton").option("-D, --mdebug", "run in debug mode").action(_newSkeleton).on('--help', function() {
